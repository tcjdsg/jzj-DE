...
class Order(object):
    ...
    def __init__(self, id,taskid, duration, RequestHumanType, needHuman, RequestStationType, ifneedSpace, successor, jzjId):
        self.id = id
        self.taskid = taskid
